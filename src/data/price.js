...
export const PRICING_DATA = {
  // Pricing plans configuration - 3 plans
  plans: [
    {
      id: "basic",
      name: "Free",
    ...
    },
    {
      ...
      employeeLimit: 24, // min 6 but limit for next plan
      seatLines: [
        "Trial: 25 seats (incl. admin)",
        "After trial: min 6 seats, unlimited employees",
      ],
      features: {
        included: [
          "Everything in Free",
          "Flexible seats: 25 in trial (incl. admin); after trial, min 6 and unlimited",
          "Auto Time Tracker",
          "Reports & analytics",
          "Docs portal",
          "Manual invoicing"
      ...
      cta: "Start Free Trial of 30 Days",
      ctaVariant: "primary",
      featured: true,
      badge: "Most Popular",
    },
    {
      ...
      employeeLimit: Infinity, // min 25
      seatLines: [
        "Trial: 50 seats (incl. admin)",
        "After trial: min 25 seats",
      ],
      features: {
        included: [
          "Everything in Pro",
          "Flexible seats: 50 in trial (incl. admin); after trial, min 25",
          "Billing management",
          "Automatic invoicing",
  ...
  faqs: [
    {
      ...
      answer:
        "Yes! We offer a 30-day free trial of our paid plans with full access to all features. No credit card required to start.",
    },
    {
      id: 2,
      question: "What happens if my employee count exceeds my plan limit?",
      answer:
        "When your employee count exceeds your current plan limit, your subscription will automatically upgrade to the next plan tier. For example, if you have 5 employees on the Free plan and add a 6th employee, you'll be upgraded to the Pro plan at ₹65/employee/month for all employees.",
    },
    {
      id: 3,
